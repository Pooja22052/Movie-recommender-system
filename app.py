...
#top50=pickle.load(open('TOP_50_MOVIES.pkl','rb'))
#movies_all=pickle.load(open('all_movies_list','rb'))
similarity=pickle.load(open('similarity.pkl','rb'))
vectorizer=pickle.load(open('npl_vectorizer.pkl','rb'))
model=pickle.load(open('reviews_model.pkl','rb'))
